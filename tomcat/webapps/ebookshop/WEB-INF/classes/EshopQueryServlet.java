...
public class EshopQueryServlet extends HttpServlet {
	...
	throws ServletException, IOException {
		System.out.println("*** doGet - EshopQueryServlet");
		...
		try {
			...
			out.println("send query to server");
			...
			//System.out.println("Finished showing list of items");
			//print the <form> start tag
			out.println("<form method='get' action='eshoporder'>");
			
			System.out.println("start <form> tag");
